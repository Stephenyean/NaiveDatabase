...
%type <expr> 		column_name literal int_literal num_literal string_literal nul_literal
%type <expr> 		comp_expr join_condition opt_having
 ...
 ******************************/
insert_statement:
		INSERT INTO table_name opt_column_list VALUES literal_lists {
...
opt_where:
		WHERE my_where_clause {$$ = $2; }
	|	/* empty */ { $$ = NULL; }
	;

my_where_clause:
		my_where_clause AND expr { 
			$1->push_back($3); 
			$$ = $1;
		}
	|	expr{
...
literal_lists:
	...
	|	literal_lists ',' '(' literal_list ')' { $1->push_back($4); $$ = $1; }
	;
...
binary_expr:
	...
	|	expr IS expr {$$ = Expr::makeOpBinary($1, 'y', $3);}
	|	expr IS NOT expr {$$ = Expr::makeOpBinary($1, 'n', $4);}
	;
